            ...
            <header class="sticky top-0 z-20 border-b border-slate-200 bg-white/95 backdrop-blur">
                <div class="flex items-center justify-between px-4 py-4 sm:px-6 lg:px-8">
                    <div class="flex min-w-0 items-center gap-3">
                        ...
                        <div>
                            <p class="text-xs font-semibold uppercase tracking-[0.3em] text-slate-500">Guest Access</p>
                            <h1 class="mt-1 text-lg font-semibold text-slate-900">{{ config('app.name', 'Laravel') }}</h1>
                        </div>
                    </div>

                    <div class="hidden text-right sm:block">
                        <p class="text-sm font-medium text-slate-900">Authentication</p>
                        <p class="text-xs uppercase tracking-[0.2em] text-slate-500">Login or register</p>
                    </div>
                </div>
            </header>

            <main class="flex flex-1 items-center px-4 py-8 sm:px-6 lg:px-8">
                <div class="mx-auto w-full max-w-md rounded-2xl border border-slate-200 bg-white px-6 py-8 shadow-sm sm:px-8">
                    <div class="mb-6 flex justify-center">
                        <a href="/">
                            <x-application-logo class="h-16 w-16 fill-current text-slate-500" />
                        </a>
                    </div>
